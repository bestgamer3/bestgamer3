...
Put both files in the MW2 2009 game folder beside `iw4sp.exe`, ensure your headset software is configured as the active OpenXR runtime, then run:
...
If `iw4sp.exe` is not already running, the companion tries to start it from the same directory.
